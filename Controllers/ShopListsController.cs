...
namespace Dumitru_Delia_Lab11.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Dumitru_Delia_Lab11Context _context;

        public ShopListsController(Dumitru_Delia_Lab11Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<ShopList>> PostShopList(ShopList shopList)
        {
          if (_context.ShopList == null)
          {
              return Problem("Entity set 'Dumitru_Delia_Lab11Context.ShopList'  is null.");
          }
